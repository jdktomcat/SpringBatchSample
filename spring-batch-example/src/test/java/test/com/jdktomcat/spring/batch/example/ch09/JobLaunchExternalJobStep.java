 ...
 * 2013-9-30上午11:11:09
 */
public class JobLaunchExternalJobStep {
	
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		JobLaunchBase.executeJob("ch09/job/job-external-job.xml", "externalJobJobStep",
				new JobParametersBuilder().addDate("date", new Date())
						...
						.addString("writeTarget","file:target/ch09/externalJob/outputFile.csv"));
	}
}
